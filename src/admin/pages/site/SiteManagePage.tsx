...
const SiteManagePage = () => {
  ...
  return (
    <div className='flex flex-col gap-10'>
      <TitleTextItem label='사이트 관리' />
      <div>
        <TitleTextItem size='sub-title' label='사이트명' className='mb-2 block text-text_black' />
      ...
      <div className='relative h-[50vh]'>
        <TitleTextItem size='sub-title' label='푸터내용' className='mb-2 block text-text_black' />
